...
var Tooltip = (function (_Component) {
    ...
    function Tooltip() {
        ...
        this.handleOutsideClick = function (event) {
            var element = (0, _react.findDOMNode)(_this);
            var tooltip = (0, _react.findDOMNode)(_this.tooltip);
    ...
    _createClass(Tooltip, [{
        ...
        value: function renderContent() {
            ...
            _react2['default'].render(this.props.content, this.tooltip, function () {
        ...
        value: function addListeners() {
            ...
            var element = (0, _react.findDOMNode)(this);
